...
The low frequency signal's lack of attenuation is due to $C_S$ and $R_S$. These components extend the bandwidth by stabilizing the voltage at $V_S$.Now I will analyze the circuit's performance for a high frequency signal.
